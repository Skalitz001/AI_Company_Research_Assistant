...
The following sample PDFs were generated by the application and are included to demonstrate the report layout and structured output:

- [OpenAI research report](Openai-research-report.pdf)
- [Linear research report](Linear-research-report.pdf)
- [Stripe research report](Stripe___Financial_Infrastructure_to_Grow_Your_Revenue-research-report.pdf)
